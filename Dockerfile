...
RUN apk add --no-cache ca-certificates wget unzip && \
    ...
    wget -P /tmp/ https://github.com/xLandor4/TwitchDropsMiner/releases/download/dev-build/Twitch.Drops.Miner.Linux.musl.PyInstaller-${ARCH_SUFFIX}.zip && \
...
ENV TDM_VERSION_TAG=16.dev.db00403
